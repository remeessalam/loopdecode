            ...
            <div className="row ">
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div className="widget widget_about">
                  ...
                  <p>
                    Empowering growth through innovation and commitment. At LOOP
                    DECODE, we deliver solutions that drive success and build
                    lasting partnerships. Your journey, our expertise.
                  </p>
                  <div className="widget_about-call-section">
                    <div className="sx-f-call-icon" style={{ color: `black` }}>
                      <i className="flaticon-telephone" />
                    </div>
                    <div className="sx-f-call-section">
                      <span>Contact us 24/7</span>
                      <a
                        href={companyDetails.number}
                        style={{ color: `black` }}
                      >
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 col footer-col-3">
                <div className="widget widget_info">
                  <h4 className="sx-f-title" style={{ color: `black` }}>
                    Solutions
                  </h4>
                  <ul>
                    <li>
        ...
        <div className="sx-f-bottom-section">
          <div className="sx-f-social">
            <ul>
              ...
              <li>
                <a href={companyDetails.youtube}>
                  <i className="flaticon-youtube" />
                </a>
              </li>
              {/* <li>
                <a href={companyDetails.blog}>
                  <i className="flaticon-blogspot" />
                </a>
              </li> */}
            </ul>
          </div>
          <div className="sx-f-copy">
            © 2024 by{" "}
            <NavLink to="/index" style={{ color: "green" }}>
              LOOP DECODE.
            </NavLink>{" "}
            All rights reserved.
          </div>
