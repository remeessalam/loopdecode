      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-12">
          <div className="sx-about-bx4-content">
            <h2 className="sx-title">Why Choose LOOP DECODE Technologies?</h2>
            <p>
              At LOOP DECODE Technologies, we understand that choosing the right
              technology partner is crucial for your business's success. Here’s
